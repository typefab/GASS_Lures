/**
 * Popola il database con il catalogo iniziale.
 * Uso: npm run db:seed        (idempotente: cancella e ricrea catalogo, NON tocca gli ordini)
 */
...
async function main() {
  console.log("→ Pulizia catalogo esistente…");
